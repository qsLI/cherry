...
var tools = {
    ...
    jsonTool: {
        ...
        exceltojson: {
            ...
            init: function () {
                ...
                $("#testcase").click(function () {
                    $("#excelval").val("name	payment	url	asdf\naaa中文测试	999	http://www.coder.toys	asdf\nbbb	888	http://www.coder.toys	asdf\nccc中文测试	777	http://www.coder.toys	asdf\nddd	666	http://www.coder.toys	asdf\neee中文测试	555	http://www.coder.toys	asdf\nfff	444	http://www.coder.toys	asdf");
                });
                $("#clear").click(function () {
        ...
        jsonescape: {
            ...
            init: function () {
                $("#jsonval").linedtextarea({ selectedLine: 1 });
                var _this = this;
                $("#zip").click(function () {
                    _this.escapezip(1);
                });
